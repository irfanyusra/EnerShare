...
async function getContractUsingWallet(peerUserId=defaultUserId) {
    ...
    console.log("user peer user: ", peerUserId)
...
exports.getUsers = async function (peerUserId) {

    const contract = await getContractUsingWallet(peerUserId);
